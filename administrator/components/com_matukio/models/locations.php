 ...
 * @since  3.0.0
 */
class MatukioModelLocations extends JModelList
{
	/**
	...
	public function getListQuery()
	{
		...
		$query->select("cc.*")->from("#__matukio_locations AS cc");
	 ...
	 */
	public function getTable($type = 'Locations', $prefix = 'MatukioTable', $config = array())
	{
