...
$lang->load('plg_payment_cash', JPATH_ADMINISTRATOR);

if (JVERSION >= '1.6.0')
	require_once(JPATH_SITE . '/plugins/payment/cash/cash/helper.php');
else
	require_once(JPATH_SITE . '/plugins/payment/cash/helper.php');

class plgpaymentcash extends JPlugin
{
	var $_payment_gateway = 'cash';
	...
	{
		$log = plgPaymentcashHelper::Storelog($this->_name, $data);
	}
}
