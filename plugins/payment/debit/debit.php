...
$lang->load('plg_payment_debit', JPATH_ADMINISTRATOR);

if (JVERSION >= '1.6.0')
    require_once(JPATH_SITE . '/plugins/payment/debit/debit/helper.php');
else
    require_once(JPATH_SITE . '/plugins/payment/debit/helper.php');

class PlgPaymentDebit extends JPlugin
{
    var $_payment_gateway = 'payment_debít';
    var $_log = null;
    ...
    {
        $log = plgPaymentdebitHelper::Storelog($this->_name, $data);
