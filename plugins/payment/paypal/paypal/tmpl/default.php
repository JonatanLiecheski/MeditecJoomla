...
<div class="akeeba-bootstrap">
	<form action="<?php echo $vars->action_url ?>" class="form-horizontal" name="paypal" id="paypal" method="post">
		...
		<div class="form-actions">
			<input type="submit" class="btn btn-success btn-large" src="https://www.paypal.com/en_US/i/btn/x-click-but02.gif" border="0"  value="<?php echo JText::_('PAY_NOW'); ?>" alt="Make payments with PayPal - it's fast, free and secure!" />
		</div>
	</form>
</div>
...
<script type="text/javascript">
	window.onload=function(){
		var inv = window.setInterval(function(){redirect(); clearInterval(inv);}, 10000);
	}
