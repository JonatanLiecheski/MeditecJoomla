...
$lang->load('plg_payment_banktransfer', JPATH_ADMINISTRATOR);
if (JVERSION >= '1.6.0')
    require_once(JPATH_SITE . '/plugins/payment/banktransfer/banktransfer/helper.php');
else
    require_once(JPATH_SITE . '/plugins/payment/banktransfer/helper.php');
class plgpaymentbanktransfer extends JPlugin
{
    var $_payment_gateway = 'payment_banktransfer';
    var $_log = null;
    ...
    {
        $log = plgPaymentbanktransferHelper::Storelog($this->_name, $data);
