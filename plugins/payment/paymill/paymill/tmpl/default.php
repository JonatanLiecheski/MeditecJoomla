			...
			<form id="card-tds-form" name="second" action="<?php echo $vars->url; ?>" method="POST" class="form-validate form-horizontal">
				<div id="field">
					<div class="control-group">
						...
						<div class="controls">
							<input class="card-holdername"  type="text" size="20" value="<?php echo $vars->user_firstname;?>" />
						</div>
					</div>
				</div>
				<div class="control-group">
				...
				<div id="cc">
					<div class="control-group">
							...
							<div class="controls">
								<input class="card-number" type="text" maxlength="16" size="20" value="" />
							</div>
					</div>
					<div class="control-group">
							<label class="control-label"><?php echo JText::_('EXPIRY') ;?></label>
							<div class="controls">
								<input class="card-expiry-month" type="text" size="2" maxlength="2" style="width:20px;"/>/
								<input class="card-expiry-year" type="text" size="4"  maxlength="4" style="margin-left: 0px;width:50px;"/>
								&nbsp;<?php echo JText::_('CVC') ;?>
								<input class="card-cvc" type="text" maxlength="4" size="4" value="" style="width:65px;"/>
							</div>
					</div>
				</div>
				<div id="bank" style="display:none;">
							 <div class="control-group">
									...
									<div class="controls">
										<input class="debit-number" maxlength="10" type="text" size="20" value="" />
									</div>
							</div>
							<div class="control-group">
									<label class="control-label"><?php echo JText::_('BANK_CODE_NUMBER') ;?></label>
									<div class="controls">
										<input class="debit-bank" maxlength="8" type="text" size="20" value="" />
									</div>
							</div>
							<div class="control-group">
									<label class="control-label"><?php echo JText::_('COUNTRY') ;?></label>
									<div class="controls">
										<input class="debit-country" type="text" size="20" value="" />
									</div>
							</div>
				</div>
				<div style="display:none;"class="control-group">
						...
						<div class="controls">
							<input class="card-amount" type="text" size="4" value="<?php echo $vars->amount;?>" />
						</div>
				</div>
				<div style="display:none;" class="control-group">
					<label class="control-label"><?php echo JText::_('CURRENCY') ;?></label>
					<div class="controls">
						<input class="card-currency" type="text" size="4" value="<?php echo $vars->currency_code;?>" />
					</div>
			   ...
			   <div class="form-actions">
				   <input id="paymill_button"  onclick="submitme();" type="button" value="<?php echo  JText::_('SUBMIT') ;?>"/>
			   </div>
		</form>
   </div>
